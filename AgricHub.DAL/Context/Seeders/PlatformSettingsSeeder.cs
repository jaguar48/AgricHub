    ...
    public static class PlatformSettingsSeeder
    {
        public static async Task SeedAsync(AgricHubDbContext db)
        {
            ...
            var settings = new List<PlatformSetting>
            {
                ...
                new() { Key="platform.supportEmail",Value="support@agrichub.io",         Category="general", Label="Support email",      InputType="text",   SortOrder=4 },
                ...
                new() { Key="email.senderEmail",    Value="noreply@agrichub.io",         Category="email",   Label="Sender email",      InputType="text",   Group="sender",     SortOrder=3 },
